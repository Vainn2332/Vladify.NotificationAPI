...
public interface INotificationService
{
    ...
    public Task<UserNotificationSettingsModel> PatchSubscriptionAsync(UserNotificationSubscriptionPatchRequestModel patchRequestModel, CancellationToken cancellationToken);
}
